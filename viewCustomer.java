...
public class viewCustomer extends JFrame  {
    ...
    public viewCustomer() {
      ...
      private void initializeUI() {
        ...
        // JLabel at the top
        JLabel welcomeLabel = new JLabel("Welcome to Customers List");
    ...
    private void displayDataInTextArea() {
        for (int i = 0; i < idList.size(); i++) {
            productTextArea.append("Item ID: " + idList.get(i) + "\n");
            productTextArea.append("Customer Name: " + nameList.get(i) + "\n");
